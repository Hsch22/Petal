...
class UserManager:
    ...
    def __init__(self, config):
        ...
        self.ensure_directory_exists(self.user_data_dir)
        ...
        self.ensure_directory_exists(self.chat_history_dir)
    ...
    def save_chat_history(self, chat_id, history):
        ...
        保存聊天历史
        参数:
            chat_id: 聊天ID，如果为None则自动生成
            history: 聊天历史，格式为[[用户消息列表], [AI回复列表]]
        """
        if not chat_id:
